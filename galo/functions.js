    ...
    function clearTable () {
        ...
        function winningCondition() {
            ...
            if (whoWon(1, 2, 3) || whoWon(4, 5, 6) || whoWon(7, 8, 9) ||
               ...
               // $(".cell").off("click");
                clearTable ();
                alert("Parabens o jogador " + winner + " venceu esta jogada, vejamos quem ganhará a melhor de 5!");
                // resetBtn.classList.remove ("reset");
                counter = 9;
            } else if (counter <= 0){
                clearTable()
        ...
        function roundWinner () {
            if (rondas === 5) {
                if (player1Points > player2Points) {
                    alert ("<h1>O jogador 1 venceu!</h1>");
                    $(".cell").off("click");
                } else { alert ("<h1>O jogador 1 venceu!</h1>");
                        $(".cell").off("click");
                    }
            }
        }
